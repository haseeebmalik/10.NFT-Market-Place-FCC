...
//     ? describe.skip
//     : describe("Mft Marketplace Tests", function () {
...
//           player= players[1]
//               //This will run all our deploy folder files.

//               await deployments.fixture(["all"])
//               //By default it will connect to deployer accounts.
//               nftMarketplaceContract = await ethers.getContract(
//                   "NFTMarketplace"
//               )
//               //You can connect it to any accout to call contract functions.
...
//               const playerConnectedToNftMarketplace=await nftMarketplaceContract.connect(player)
